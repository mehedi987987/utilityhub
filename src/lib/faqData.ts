...
export const faqSections: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: 'Do I need an account to use Work Gate?',
        a: 'For 25 of the 27 tools, no — open them and start working. Only Remove Background and AI Image Enhancer ask you to sign in, because each run of those costs us money at an external AI provider.',
      },
      {
        q: 'Why do those two tools need an account?',
        a: 'They call a paid AI service on every run. Without a sign-in, a single script could burn through the whole budget in minutes and the tools would be down for everyone. Signing up is free and takes a few seconds.',
      },
      {
        q: 'What are tokens?',
        a: 'Tokens are free credits for the two AI tools. You get 100 when you sign up, each run costs 10, and you can top up any time by watching a short ad or claiming the daily bonus. The other 25 tools do not use tokens at all.',
      },
      {
      ...
      },
      {
        ...
        a: 'Ads pay for the AI services and hosting, which is what keeps every tool free and free of usage limits. We keep them to a single banner per page, never place one in the middle of a tool, and do not use popunders.',
      },
    ],
  },
  {
